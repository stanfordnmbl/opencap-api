# Generated by Django 3.1.14 on 2023-06-23 05:57
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mcserver', '0017_analysis_function_models'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            name='state',
            field=models.CharField(choices=[('pending', 'Pending'), ('successfull', 'Successful'), ('failed', 'Failed')], default='pending', help_text='The state of invokation request.', max_length=20, verbose_name='Invokation state'),
        ),
